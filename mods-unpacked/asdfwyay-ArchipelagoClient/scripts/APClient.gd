...
const APPacket = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/common/APPacket.gd")
const JSONMessagePart = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/common/JSONMessagePart.gd")
const NetworkPlayer = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/common/NetworkPlayer.gd")
const NetworkSlot = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/common/NetworkSlot.gd")
const NetworkVersion = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/common/NetworkVersion.gd")

const Bounce = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/Bounce.gd")
const Connect = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/Connect.gd")
const ConnectUpdate = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/ConnectUpdate.gd")
const CreateHints = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/CreateHints.gd")
const Get = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/Get.gd")
const GetDataPackage = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/GetDataPackage.gd")
const LocationChecks = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/LocationChecks.gd")
const LocationScouts = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/LocationScouts.gd")
const Say = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/Say.gd")
const Set = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/Set.gd")
const StatusUpdate = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/StatusUpdate.gd")
const Sync = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/client/Sync.gd")

const Bounced = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/server/Bounced.gd")
const Connected = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/server/Connected.gd")
const ConnectionRefused = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/server/ConnectionRefused.gd")
const DataPackage = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/server/DataPackage.gd")
const LocationInfo = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/server/LocationInfo.gd")
const PrintJSON = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/server/PrintJSON.gd")
const ReceivedItems = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/server/ReceivedItems.gd")
const RoomInfo = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/resources/server/RoomInfo.gd")

const uuidUtil = preload("res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/utils/uuid.gd")
