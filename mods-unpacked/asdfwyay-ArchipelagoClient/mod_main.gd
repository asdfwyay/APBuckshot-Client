...
func install_script_hook_files() -> void:
	...
	ModLoaderMod.install_script_hooks(
		...
		"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/ShotgunShooting.hooks.gd"
	)
	ModLoaderMod.install_script_hooks(
		"res://scripts/RoundManager.gd",
		"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/RoundManager.hooks.gd"
	)
	ModLoaderMod.install_script_hooks(
		"res://scripts/MenuManager.gd",
		"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/MenuManager.hooks.gd"
	)
	ModLoaderMod.install_script_hooks(
		"res://scripts/ItemManager.gd",
		"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/ItemManager.hooks.gd"
	)
	ModLoaderMod.install_script_hooks(
		"res://scripts/AchievementManager.gd",
		"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/AchievementManager.hooks.gd"
	)
	ModLoaderMod.install_script_hooks(
		"res://scripts/DonUnlockManager.gd",
		"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/DonUnlockManager.hooks.gd"
	)
	ModLoaderMod.install_script_hooks(
		"res://scripts/UserExit.gd",
		"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/UserExit.hooks.gd"
	)
	ModLoaderMod.install_script_hooks(
		"res://scripts/DeathManager.gd",
		"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/DeathManager.hooks.gd"
	)
	ModLoaderMod.install_script_hooks(
		"res://scripts/EndingManager.gd",
		"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/EndingManager.hooks.gd"
	)
	ModLoaderMod.install_script_hooks(
		"res://scripts/DealerIntelligence.gd",
		"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/DealerIntelligence.hooks.gd"
	)
	#ModLoaderMod.install_script_hooks(
	#	"res://multiplayer/scripts/MP_LobbyManager.gd",
	#	"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/multiplayer/MP_LobbyManager.hooks.gd"
	#)
	#ModLoaderMod.install_script_hooks(
	#	"res://multiplayer/scripts/MP_LobbyUI.gd",
	#	"res://mods-unpacked/asdfwyay-ArchipelagoClient/scripts/hooks/multiplayer/MP_LobbyUI.hooks.gd"
	#)
